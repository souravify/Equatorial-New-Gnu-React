...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Equatorial New Gnu</title>
        <meta property="og:title" content="Equatorial New Gnu" />
      </Helmet>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav31 bodySmall">Case Studies</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">
              Welcome to the Modern Marketer Blog
            </h1>
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>
                    Stay up-to-date with the latest marketing trends and
                    strategies
                  </span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover the powerful features of our modern blog page
                    </span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Intuitive and easy-to-use interface for seamless navigation"
              ></FeatureCard>
              <FeatureCard
                heading="Responsive Design"
                subHeading="Optimized for all devices to ensure a consistent experience"
              ></FeatureCard>
              <FeatureCard
                heading="Social Media Integration"
                subHeading="Easily share blog posts on various social media platforms"
              ></FeatureCard>
              <FeatureCard
                heading="Advanced Analytics"
                subHeading="Track and analyze blog performance with detailed analytics"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Unlock the full potential of your marketing efforts with our
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">Limited access to analytics</span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Basic email support</span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container18">
                ...
                <span className="bodySmall">
                  Premium features for established businesses
                </span>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Discover actionable insights, expert advice, and proven
                  strategies to take your marketing efforts to the next level.
                  Our blog is dedicated to helping marketers stay ahead in the
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container27">
              <Question1
                answer="The purpose of this blog page is to provide valuable insights and information for marketers."
                question="What is the purpose of this blog page?"
              ></Question1>
              <Question1
                answer="The target audience for this blog page is marketers who are looking for industry trends, tips, and strategies to enhance their marketing efforts."
                question="Who is the target audience for this blog page?"
              ></Question1>
              <Question1
                answer="The blog will be updated on a regular basis, with new content published at least once a week."
                question="How often will the blog be updated?"
              ></Question1>
              <Question1
                answer="Yes, we welcome guest posts from industry experts. Please contact us for more information on how to submit your guest post."
                question="Can I submit a guest post for this blog?"
              ></Question1>
              <Question1
                answer="You can subscribe to our newsletter or follow us on social media to receive updates on the latest blog posts."
                question="How can I stay updated with the latest blog posts?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container28">
            ...
            <nav className="home-nav1 bodySmall home-nav1">
              ...
              <span className="home-nav32 bodySmall">Case Studies</span>
